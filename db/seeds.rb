...
Lesson.create(category_id:'1', rank_id:'1', name:'囚人のジレンマ', image: open("#{Rails.root}/db/fixtures/囚人のジレンマ.jpg"), video: open("#{Rails.root}/db/fixtures/test_movie.mp4"), description:'商談や交渉などの場面で、どのような戦略をとるべきかを考えるのに役立つゲーム理論の一つとして、「囚人のジレンマ」があります。「囚人のジレンマ」と聞くとビジネスには関係がないように聞こえるかもしれませんが、この考え方は私たちの日常やビジネスでの意思決定場面でもよく起こるものです。', time:'1800', status:'公開中')
Lesson.create(category_id:'1', rank_id:'1', name:'クリティカル・シンキングⅠ', image: open("#{Rails.root}/db/fixtures/クリティカルシンキング.jpg"), video: open("#{Rails.root}/db/fixtures/test_movie.mp4"), description:'業種、職種、役職を問わずビジネスパーソンが業務のスピードとクオリティを効率よく高めるために必要不可欠な論理思考力。論理思考のベースとなる考え方を学び、実務で陥りやすい注意点を理解することで、実践で活用する能力を養います。', time:'1800', status:'公開中')
Lesson.create(category_id:'1', rank_id:'1', name:'フェルミ推定', image: open("#{Rails.root}/db/fixtures/フェルミ推定.jpg"), video: open("#{Rails.root}/db/fixtures/test_movie.mp4"), description:'フェルミ推定は、正確な数値がすぐに分からない時などに、入手しやすい情報等をもとに、論理的に推論し、概算の値を求めることです。コンサルティング会社や外資系企業の採用試験や面接で使われることもあり、論理的思考力を確認するために活用されることもあります。', time:'1800', status:'公開中')
Lesson.create(category_id:'1', rank_id:'2', name:'散布図', image: open("#{Rails.root}/db/fixtures/散布図.jpg"), video: open("#{Rails.root}/db/fixtures/test_movie.mp4"), description:'散布図は2つの数字の関係を見ることができるグラフです。円グラフや折れ線グラフなどグラフには様々な種類がありますが、2つの変数の関係性を調べるときには、散布図が有効です。2つの数字を「比較」し、関係を見極めることで「因果関係」を推し量ることができます。', time:'1800', status:'公開中')
Lesson.create(category_id:'1', rank_id:'2', name:'相関分析', image: open("#{Rails.root}/db/fixtures/相関分析.jpg"), video: open("#{Rails.root}/db/fixtures/test_movie.mp4"), description:'相関分析とは二次元の図表に2つの軸をとり各要素の関連性を見る分析手法です。物事の因果関係を見たり、物事に影響を与える重要な要素を見極めるヒントを得ることができます。', time:'1800', status:'公開中')
Lesson.create(category_id:'1', rank_id:'2', name:'クリティカル・シンキングⅡ', image: open("#{Rails.root}/db/fixtures/クリティカルシンキング2.jpg"), video: open("#{Rails.root}/db/fixtures/test_movie.mp4"), description:'「問題解決力」は新入社員から経営者まで、ビジネス、プライベートを問わず日常的に必要なスキルです。そもそも問題解決とは何かを、正しい問題解決のステップと、各ステップでの留意点を踏まえながら学んでいきます。', time:'1800', status:'公開中')
Lesson.create(category_id:'1', rank_id:'3', name:'演繹的／帰納的思考', image: open("#{Rails.root}/db/fixtures/演繹的_帰納的思考.jpg"), video: open("#{Rails.root}/db/fixtures/test_movie.mp4"), description:'演繹的／帰納的思考は、結論と根拠を適切に結びつける思考法で、論理的思考力を身につける上で必須となる思考法です。クリティカル・シンキングを学んでいる方は、ぜひこの思考法を理解しておきましょう。', time:'1800', status:'公開中')
